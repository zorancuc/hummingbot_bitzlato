...
from . import bitzlato_constants as Constants
...
KEYS = {
    "bitzlato_api_key":
        ConfigVar(key="bitzlato_api_key",
                  prompt="Enter your www.bitzlato.dev API key >>> ",
                  required_if=using_exchange("bitzlato"),
                  is_secure=True,
                  is_connect_key=True),
    "bitzlato_secret_key":
        ConfigVar(key="bitzlato_secret_key",
                  prompt="Enter your www.bitzlato.dev secret key >>> ",
                  required_if=using_exchange("bitzlato"),
                  is_secure=True,
                  is_connect_key=True),
}
